...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('SD', 'Specific Date In Future'), ('W', 'Wedding'), ('CB', 'Child Birth'), ('M', 'Marriage'), ('D', 'Death')], default='SD', max_length=10),
        ),
        migrations.AlterField(
            model_name='capsule',
            name='file',
